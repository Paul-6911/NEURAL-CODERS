...
class AppModule {
    ...
    @Provides
    @Singleton
    @Named("provideSharePreferencesEncrypted")
    fun provideSharePreferencesEncrypted(@ApplicationContext context: Context): SharedPreferences {
